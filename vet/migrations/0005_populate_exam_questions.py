...
data_dict = [
    ...
    {'name':'MM Texture', 'options':['Moist', 'Tacky', 'Ropey saliva'], 'categories':['cat', 'dog', 'avian', 'small mammal', 'camelid', 'ruminant', 'equine', 'swine'], 'allow_not_examined':True, 'open_notes':False},
    ...
    {'name':'Eyes', 'options':['NSF', 'Discharge', 'Blepharospasm', 'Nuclear sclerosis', 'Cataracts', 'Ulcer', 'Other'], 'categories':['cat', 'dog', 'avian', 'small mammal', 'reptile/amphibian', 'camelid', 'ruminant', 'equine', 'swine'], 'allow_not_examined':True, 'open_notes':True},
