...
class ModestAnimalSerializer(SimpleAnimalSerializer):
    ...
    class Meta:
        ...
        'microchip', 'front_image', 'intake_date', 'sip_date', 'owners', 'owner_names', 'active_dispatch', 'sex', 'size', 'age', 'pcolor', 'scolor', 'medical_notes', 'medical_record', 'behavior_notes', 'room', 'room_name', 'category', 'address', 'apartment', 'city', 'state', 'zip_code', 'latitude', 'longitude', 'weight', 'reporter', 'reporter_object', 'last_seen']
    ...
    def get_active_dispatch(self, obj):
        return obj.request and obj.request.status == 'assigned'
