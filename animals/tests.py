...
class TestViews(APITestCase):
    ...
    def test_search_animal(self):
        self.animal = Animal.objects.create(name='Einstein', owner=self.owner)
        self.client.force_authenticate(self.user)
    ...
    def test_create_animals(self):
        ...
        self.assertTrue(Animal.objects.filter(owner=self.new_owner, name='Phineas', status="REPORTED").exists())
