...
class SimpleServiceRequestSerializer(BarebonesServiceRequestSerializer):
    ...
    class Meta:
        ...
        'images', 'animal_count', 'key_provided', 'verbal_permission', 'injured', 'accessible', 'turn_around', 'animals', 'status', 'reported_animals', 'reporter_object', 'owner_objects', 'reported_sheltered_in_place', 'sheltered_in_place', 'unable_to_locate', 'aco_required']
...
class ServiceRequestSerializer(SimpleServiceRequestSerializer):
    ...
    class Meta:
        ...
        'injured', 'accessible', 'turn_around', 'animals', 'reporter', 'reported_animals', 'sheltered_in_place', 'reported_sheltered_in_place', 'unable_to_locate', 'aco_required',
