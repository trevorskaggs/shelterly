...
class TestViews(APITestCase):
    ...
    def test_create_service_request_owner(self):
        ...
        response = self.client.post(f'/hotline/api/servicerequests/', {'owners':[self.new_person.pk], 'address':"123 Main St.", 'directions':"Turn left.", 'latitude':self.new_person.latitude, 'longitude':self.new_person.longitude}, format='json')
