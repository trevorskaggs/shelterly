...
class TestViews(APITestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.incident = Incident.objects.create(name='Test2', slug='test2', latitude=0, longitude=0)
    ...
    def test_create_service_request_owner(self):
        self.new_incident = Incident.objects.create(name='Test3', slug='test3', latitude=0, longitude=0)
    ...
    def test_create_service_request_no_owner(self):
        self.new_incident = Incident.objects.create(name='Test4', slug='test4', latitude=0, longitude=0)
