...
class TestViews(APITestCase):
    ...
    def test_create_service_request_owner(self):
        ...
        response = self.client.post(f'/hotline/api/servicerequests/', {'owner':self.new_person.pk, 'address':"123 Main St.", 'directions':"Turn left.", 'latitude':self.new_person.latitude, 'longitude':self.new_person.longitude})
    ...
    def test_create_service_request_no_owner(self):
        ...
        response = self.client.post(f'/hotline/api/servicerequests/', {'reporter':self.person.pk, 'address':"123 Main St.", 'directions':"Turn left.", 'latitude':0, 'longitude':0})
        self.assertEqual(response.status_code, 201)
