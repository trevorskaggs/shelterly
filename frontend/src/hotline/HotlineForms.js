...
import {
  Form as BootstrapForm, Button, ButtonGroup, Card, Col, FormGroup, Row,
        ...
        await axios.get(`/people/api/person/${owner_id}/`, {
          ...
          .then((response) => {
            ...
            setData(Object.assign(data, {
              address: response.data.address, apartment: response.data.apartment, city: response.data.city, state: response.data.state, zip_code: response.data.zip_code,
            }));
            setFadeIn(!response.data.address);
          })
          .catch((error) => {
            console.log(error.response);
          });
        ...
        <Card border="secondary" className="mt-5" style={{ width: 'auto' }}>
          ...
          <Card.Body>
            <BootstrapForm as={Form}>
              ...
              <Field type="hidden" value={reporter_id || ''} name="reporter" id="reporter" />
              ...
              <BootstrapForm.Row>
                <span hidden={is_first_responder}>
