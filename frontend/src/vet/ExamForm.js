    ...
    >
      {formikProps => (
        <Card border="secondary" className="mt-3">
          ...
          <Patient animal={data.animal_object} vet_request={vetrequest_id && data.vet_requests.length > 0 ? data.vet_requests.filter(vr => vr.id === Number(vetrequest_id))[0] : data.vet_request_object} organization={props.organization} incident={props.incident} medical_plan={formikProps.values.medical_plan} />
          <Card.Body>
            <Form>
              <FormGroup>
                <BootstrapForm.Row>
