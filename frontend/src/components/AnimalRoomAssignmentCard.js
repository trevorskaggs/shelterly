...
function AnimalRoomAssignmentCard(props) {
  ...
  return (
    <>
    <Card className={"border rounded" + (props.snapshot.isDragging ? " border-danger" : "")} float="left" style={{width:"157px", marginLeft:"-5px", whiteSpace:"nowrap", overflow:"hidden", textOverflow:"ellipsis"}}>
