...
import Hotline, {
  NewServiceRequest, ServiceRequestDetail, ServiceRequestList, UpdateServiceRequest,
} from './hotline/Hotline';
import Intake, { IntakeSummary } from './intake/Intake';
import {
  NewOwner, NewReporter, OwnerDetail, ReporterDetail, UpdateOwner, UpdateReporter,
} from './people/People';
