...
const routes = {
  ...
  "/:organization/:incident/accounts/user/new": ({incident, organization}) => <UserForm incident={incident} organization={organization} />,
  "/:organization/:incident/accounts/user/edit/:id": ({id, incident, organization}) => <UserForm id={id} incident={incident} organization={organization} />,
  "/:organization/:incident/accounts/user_management": ({incident, organization}) => <UserManagement incident={incident} organization={organization} />,
