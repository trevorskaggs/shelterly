...
export const STATE_OPTIONS = [{ value: 'AL', label: "AL" }, { value: 'AK', label: "AK" }, { value: 'AZ', label: "AZ" }, { value: 'AR', label: "AR" }, { value: 'CA', label: "CA" }, { value: 'CO', label: "CO" }, { value: 'CT', label: "CT" },
...
export const S3_BUCKET = 'https://shelterly-files.s3-us-west-2.amazonaws.com/static/v0.3/'