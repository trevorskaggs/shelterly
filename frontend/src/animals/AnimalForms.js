...
import {
  Col, Button, ButtonGroup, Form as BootstrapForm, Card,
} from 'react-bootstrap';

import * as Yup from 'yup';
import { DateTimePicker, DropDown, TextInput } from '../components/Form.js';
import {
  catAgeChoices, dogAgeChoices, horseAgeChoices, otherAgeChoices, catColorChoices, dogColorChoices, horseColorChoices, otherColorChoices, speciesChoices, sexChoices, dogSizeChoices, catSizeChoices, horseSizeChoices, otherSizeChoices, statusChoices, unknownChoices,
} from './constants';
...
export const AnimalForm = ({ id }) => {
  ...
  const is_intake = window.location.pathname.includes('intake');
  ...
  const is_first_responder = (first_responder == 'true');
  ...
  const ageChoices = {
    '': [], dog: dogAgeChoices, cat: catAgeChoices, horse: horseAgeChoices, other: otherAgeChoices,
  };
  const colorChoices = {
    '': [], dog: dogColorChoices, cat: catColorChoices, horse: horseColorChoices, other: otherColorChoices,
  };
  const sizeChoices = {
    '': [], dog: dogSizeChoices, cat: catSizeChoices, horse: horseSizeChoices, other: otherSizeChoices,
  };
          ...
          <Card border="secondary" className="mt-5">
            ...
            <Card.Body>
              <BootstrapForm as={Form}>
                <Field type="hidden" value={owner_id || ''} name="owner" id="owner" />
                <Field type="hidden" value={servicerequest_id || ''} name="request" id="request" />
